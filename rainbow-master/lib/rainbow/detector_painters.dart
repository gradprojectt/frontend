...
class FaceDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint = Paint()
      ...
      ..color = color ?? ui.Color.fromARGB(255, 170, 0, 0).withOpacity(0.5)
    ...
    for (final Face face in faces) {
      ...
      drawUpperLip(
          canvas, ULBContour!, size, scaleX, scaleY, ULTContour!, paint);

      drawLowerLip(
          canvas, LLBContour!, size, scaleX, scaleY, LLTContour!, paint);
